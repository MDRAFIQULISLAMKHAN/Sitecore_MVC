...
var markersEn = [
	{
		...
		img: 'Airport2.jpg',
		text: 'Due for completion in 2022, Red Sea International Airport will serve an estimated one million tourists per year by 2030 with a schedule of domestic and international flights, and a peak capacity of 900 passengers per hour.',
		content: [
			{
				icon: 'luggage',
				title: 'Smart Luggage',
